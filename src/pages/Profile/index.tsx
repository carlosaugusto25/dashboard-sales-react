...
//COMPONENTS
import { Header, StyledButton, CardComponent, StyledH1, FormComponent, StyledH2 } from "@/components";
...
//TYPES
import { InputProps, ProfileDataProps, ProfileEditableDataProps, MessageProps } from "@/types";
...
export function Profile() {
    ...
    const handleDelete = async () => {
        if (confirm('Deseja realmente excluir sua conta? Se sim, certifique-se de deletar os seus leads antes,')) {
            try {
