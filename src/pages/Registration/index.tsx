                        ...
                        <Container maxWidth='sm'>
                            ...
                            <Box sx={{ marginBottom: pixelToRem(24) }}>
                                ...
                                <StyledP>{email ? 'Sua senha deve ter:' : 'Primeiro, diga-nos quem você é.'}</StyledP>
                                {
                                    email &&
                                    <StyledUl>
                                        <li>{validationPassword.hasCorrectLenght ? <FaCheck color='#008000' size={16} /> : <FaTimes color='#e80000' size={16} />}Entre 8 a 16 caracteres;</li>
                                        <li>{validationPassword.hasUppercase ? <FaCheck color='#008000' size={16} /> : <FaTimes color='#e80000' size={16} />}Pelo menos uma letra maiúscula;</li>
                                        <li>{validationPassword.hasNumber ? <FaCheck color='#008000' size={16} /> : <FaTimes color='#e80000' size={16} />}Pelo menos um número;</li>
                                        <li>{validationPassword.hasSpecialChar ? <FaCheck color='#008000' size={16} /> : <FaTimes color='#e80000' size={16} />}Pelo menos um caractere especial.</li>
                                    </StyledUl>
                                }
                            </Box>
                            ...
                            <FormComponent
                                inputs={handleStepInputs.map((input, index) => ({
                                    ...
                                    onChange: (e: ChangeEvent<HTMLInputElement>) => email ? step2HandleChange(index, (e.target as HTMLInputElement).value) : step1HandleChange(index, (e.target as HTMLInputElement).value),
                                }))}
                                buttons={[
                                    {
                                        className: 'primary',
